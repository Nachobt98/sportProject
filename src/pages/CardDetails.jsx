          ...
          <Stack direction="row" spacing={1} sx={{ flexWrap: "wrap", justifyContent: "flex-end" }}>
            ...
            {canManageActiveEvent && (
              <Button
                ...
                onClick={() => setConfirmAction(DETAIL_CONFIRM_ACTIONS.CANCEL_EVENT)}
              >
                Cancelar evento
              </Button>
            )}
            {(status === EVENT_STATUS.CANCELLED || status === EVENT_STATUS.PAST) && (
              <Button
                ...
                onClick={() => setConfirmAction(DETAIL_CONFIRM_ACTIONS.DISMISS_EVENT)}
              >
                Borrar de mi perfil
              </Button>
            )}
            {canManageActiveEvent && (
              <Button
                ...
                onClick={() => setConfirmAction(DETAIL_CONFIRM_ACTIONS.DELETE_EVENT)}
              >
